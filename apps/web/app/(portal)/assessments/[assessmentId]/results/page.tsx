...
export default function AssessmentResults() {
  ...
  return (
    <PageShell title="Assessment Results" breadcrumbs={[{ label: "Assessments", href: "/assessments" }, { label: "Detail", href: `/assessments/${assessmentId}` }, { label: "Results" }]} allowedRoles={["SUPER_ADMIN", "ADMIN"]}>
